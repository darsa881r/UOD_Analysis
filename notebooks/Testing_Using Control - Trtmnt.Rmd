...
#plot(newdata$PreScore, newdata$PostScore)
t.test(newdata$PostScore, newdata$PreScore, mu = 0, alt = "two.sided", paired = T, conf.level = 0.95)

wilcox.test(newdata$PostScore, newdata$PreScore, mu = 0, alt = "two.sided", paired = T, conf.int = T, conf.level = 0.95, exact = F, correct = F)
