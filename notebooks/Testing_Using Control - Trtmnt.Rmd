...
questions <- as.factor(c(rep(c("Q1. Do you know anyone with autism?"),4),rep(c("Q3a.Most people with autism all act the same."), 3),rep(c("Q3b. The brain is the part of the body that is affected by autism."), 3),rep(c("Q3c. Many people with autism have a really strong interest in one specific topic."), 3),rep(c("Q3d. Bright lights or loud noises don’t really bother most people with autism."), 3),rep(c("Q3e. Most people with autism are really good at knowing when someone is mad, or worried, or happy."), 3)))
...
ggplot(newdata_melted, aes(x=Scores, fill=Tests)) + 
  geom_histogram(breaks=seq(0,100, by=10), 
                 col="blue") +
  ggtitle("Distribution of avg Pre & Post Scores \n by Schools")
...
newdata2$Treat01 <- c(rep(0,nrow(newdata2)))
newdata2$Treat02 <- c(rep(0,nrow(newdata2)))
newdata2$Treat03 <- c(rep(0,nrow(newdata2)))
newdata2$Treat04 <- c(rep(0,nrow(newdata2)))



newdata2$Treat01[which(newdata2$Schools == "B" & newdata2$Tests == "PreScore")] <- 1
newdata2$Treat01[which(newdata2$Schools == "B" & newdata2$Tests == "PostScore")] <- 2
newdata2$Treat01[which(newdata2$Schools == "F" & newdata2$Tests == "PreScore")] <- 3
newdata2$Treat01[which(newdata2$Schools == "F" & newdata2$Tests == "PostScore")] <- 4
newdata2$Treat01[which(newdata2$Schools == "M" & newdata2$Tests == "PreScore")] <- 5
newdata2$Treat01[which(newdata2$Schools == "M" & newdata2$Tests == "PostScore")] <- 6
newdata2$Treat01[which(newdata2$Schools == "P" & newdata2$Tests == "PreScore")] <- 7
newdata2$Treat01[which(newdata2$Schools == "P" & newdata2$Tests == "PostScore")] <- 8


newdata2$Treat01 <- as.factor(newdata2$Treat01)

#rawdata <- rawdata[-which(rawdata$Subjects == "F4"),]


newdata2$Treat02[which(newdata2$Schools == "B" & newdata2$Tests == "PreScore")] <- 1
newdata2$Treat02[which(newdata2$Schools == "B" & newdata2$Tests == "PostScore")] <- 2
newdata2$Treat02[which(newdata2$Schools == "F" & newdata2$Tests == "PreScore")] <- 1
newdata2$Treat02[which(newdata2$Schools == "F" & newdata2$Tests == "PostScore")] <- 2
newdata2$Treat02[which(newdata2$Schools == "M" & newdata2$Tests == "PreScore")] <- 3
newdata2$Treat02[which(newdata2$Schools == "M" & newdata2$Tests == "PostScore")] <- 4
newdata2$Treat02[which(newdata2$Schools == "P" & newdata2$Tests == "PreScore")] <- 3
newdata2$Treat02[which(newdata2$Schools == "P" & newdata2$Tests == "PostScore")] <- 4


newdata2$Treat02 <- as.factor(newdata2$Treat02)

newdata2$Treat03[which(newdata2$Schools == "B" & newdata2$Tests == "PreScore")] <- 1
newdata2$Treat03[which(newdata2$Schools == "B" & newdata2$Tests == "PostScore")] <- 2
newdata2$Treat03[which(newdata2$Schools == "F" & newdata2$Tests == "PreScore")] <- 3
newdata2$Treat03[which(newdata2$Schools == "F" & newdata2$Tests == "PostScore")] <- 4
newdata2$Treat03[which(newdata2$Schools == "M" & newdata2$Tests == "PreScore")] <- 1
newdata2$Treat03[which(newdata2$Schools == "M" & newdata2$Tests == "PostScore")] <- 2
newdata2$Treat03[which(newdata2$Schools == "P" & newdata2$Tests == "PreScore")] <- 3
newdata2$Treat03[which(newdata2$Schools == "P" & newdata2$Tests == "PostScore")] <- 4


newdata2$Treat03 <- as.factor(newdata2$Treat03)

newdata2$Treat04[which(newdata2$Schools == "B" & newdata2$Tests == "PreScore")] <- 1
newdata2$Treat04[which(newdata2$Schools == "B" & newdata2$Tests == "PostScore")] <- 2
newdata2$Treat04[which(newdata2$Schools == "F" & newdata2$Tests == "PreScore")] <- 3
newdata2$Treat04[which(newdata2$Schools == "F" & newdata2$Tests == "PostScore")] <- 4
newdata2$Treat04[which(newdata2$Schools == "M" & newdata2$Tests == "PreScore")] <- 3
newdata2$Treat04[which(newdata2$Schools == "M" & newdata2$Tests == "PostScore")] <- 4
newdata2$Treat04[which(newdata2$Schools == "P" & newdata2$Tests == "PreScore")] <- 1
newdata2$Treat04[which(newdata2$Schools == "P" & newdata2$Tests == "PostScore")] <- 2


newdata2$Treat04 <- as.factor(newdata2$Treat04)
...
#ggplot(newdata2, aes(x=Scores, fill=Treat02)) + 
#  geom_histogram(breaks=seq(0,100, by=20), 
#                 col="blue") 

ggplot(newdata2, aes(x = Schools, y= Scores, fill=Treat01)) +
    geom_bar(position="stack", stat="identity")

ggplot(newdata2, aes(x = Schools, y= Scores, fill=Treat02)) +
    geom_bar(position="stack", stat="identity")

ggplot(newdata2, aes(x = Schools, y= Scores, fill=Treat03)) +
    geom_bar(position="stack", stat="identity")

ggplot(newdata2, aes(x = Schools, y= Scores, fill=Treat04)) +
    geom_bar(position="stack", stat="identity")
